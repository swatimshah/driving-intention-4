...
# Create the model
model=Sequential()
model.add(Conv1D(filters=20, kernel_size=6, kernel_regularizer=L2(0.001), bias_regularizer=L2(0.001), activity_regularizer = L2(0.001), kernel_constraint=min_max_norm(min_value=-0.1, max_value=0.1), padding='valid', activation='relu', strides=1, input_shape=(64, 64)))
model.add(Conv1D(filters=20, kernel_size=5, kernel_regularizer=L2(0.001), bias_regularizer=L2(0.001), activity_regularizer = L2(0.001), kernel_constraint=min_max_norm(min_value=-0.1, max_value=0.1), padding='valid', activation='relu', strides=1))
model.add((AveragePooling1D()))
model.add(Conv1D(filters=20, kernel_size=4, kernel_regularizer=L2(0.001), bias_regularizer=L2(0.001), activity_regularizer = L2(0.001), kernel_constraint=min_max_norm(min_value=-0.1, max_value=0.1), padding='valid', activation='relu', strides=1))
model.add(GlobalMaxPooling1D())
model.add(Dense(20, kernel_regularizer=L2(0.001), bias_regularizer=L2(0.001), activity_regularizer = L2(0.001), kernel_constraint=min_max_norm(min_value=-0.1, max_value=0.1), activation='relu'))
